package net.softsociety.prolingo.security;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/", //여기 다 수정해야함
                ...
                "/images/**",
                "/style/**",
                "/script/**").permitAll()		//설정한 리소스의 접근을 인증절차 없이 허용
        ...
        .and()
        .logout().logoutUrl("/logout")		//이미 디폴트 값으로 logout이 되어있지만 바꿀 수 있는듯
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        .usersByUsernameQuery(
                ...
                "where memberid = ?")
        // 권한
        // 여기서 설정한 rolename이 html의 "principal.authorities" 속성으로 나오는듯
    ...
    // 단방향 비밀번호 암호화
    // Bean도 미리 만들어놓고 오토와이어드 할 수 있는 어노테이션
    @Bean
